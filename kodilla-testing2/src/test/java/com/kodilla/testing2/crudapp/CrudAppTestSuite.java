...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://SilverSabre92.github.io/";
    ...
    public void shouldCreateTrelloCardCrudAppTestTask() throws InterruptedException {
        ...
        Assert.assertTrue(checkTaskInCrudDoesExists(taskName));
    ...
    private boolean checkTaskInCrudDoesExists(String taskName) throws InterruptedException {
        boolean check = false;
